	...
	<div class="container f-menu-list">
		<div class="row">
			...
			<div class="f-menu">
				...
				<ul class="nav nav-pills nav-stacked">
					<li><a href="product.php">Still</a></li>
					<li><a href="product.php">Plastic</a></li>
					<li><a href="product.php">Electric Product</a></li>
					<li><a href="product.php">Athoer Product</a></li>
				</ul>
			</div>
			<div class="f-menu">
				<h3>
				...
				<ul class="nav nav-pills nav-stacked">
					<li><a href="product.php">Choppar</a></li>
					<li><a href="product.php">Wefar Machin</a></li>
					<li><a href="product.php">Juicer</a></li>
					<li><a href="product.php">Beater</a></li>
				</ul>
			</div>
			<div class="f-menu">
				<h3>
		...
		<div class="container">
			<div class="row">
				...
				<div class="footer-copyright">
					<i><a href="https://themeforest.net/user/real-web?ref=real-web">Real-Web</a></i> © Copyright 2022
				</div>
			</div>
		</div>
	</div>
